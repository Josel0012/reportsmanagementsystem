...
if ($_SESSION['user_type'] != 'program_coordinator') {
    header('Location:../login.php');
    exit();
}
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush ">
                <a href="#" data-toggle="tooltip" data-placement="right" title="Dashboard" id="dashboard_tab" class="list-group-item list-group-item-action list-group-item-light p-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                            <div class="notif">
                                <?php include '../tabs/prog-coor-notifications.inc.php' ?>
                            </div>
