...
<body>
                ...
                <form method="post" role="form" id="form-edit-pass">
                    ...
                    <div class="modal-body w-100 text-center">
                        <div class="input-group mb-3">
                            ...
                            <input type="password" class="form-control" id="old-pass" name="firstname" placeholder="Enter old password" />
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bxs-id-card'></i></span>
                            </div>
                            <input type="password" class="form-control" id="new-pass" name="firstname" minlength="8" placeholder="Enter new password" />
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bxs-id-card'></i></span>
                            </div>
                            <input type="password" class="form-control" id="c-new-pass" name="firstname" minlength="8" placeholder="Confirm Password" />
                        </div>
                    </div>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end " id="sidebar-wrapper">
            <div class="sidebar-heading text-center">CCT</div>
            ...
            <div class="name_lastname text-center mb-3 p-0">
                <div><?php echo $_SESSION['username'] ?></div>
                <span style="font-size: 14px;">
                    <?php if ($_SESSION['user_type'] == 'school_dean') {
                        echo "School Dean";
                    } elseif ($_SESSION['user_type'] == "program_coordinator") {
                        echo "Program Coordinator";
                    } elseif ($_SESSION['user_type'] == "system_administrator") {
            ...
            <div class="list-group list-group-flush">
                <a href="#" data-toggle="tooltip" data-placement="right" title="Dashboard" id="dashboard_tab" class="list-group-item list-group-item-action list-group-item-light active p-3">
                    <i class='bx bx-desktop'></i>
                    <span class="links_name">Dashboard</span>
                </a>

                <a href="#" data-toggle="tooltip" data-placement="right" title="U s e r s" id="user_tab" class="list-group-item list-group-item-action list-group-item-light p-3">
                ...
                <a href="#" data-toggle="tooltip" data-placement="right" title="Semester" id="semester" class="list-group-item list-group-item-action list-group-item-light p-3">
                ...
                <a href="#" data-toggle="tooltip" data-placement="right" title="Log Activities" id="log_act" class="list-group-item list-group-item-action list-group-item-light p-3">
                    <i class='bx bx-clipboard'></i>
                    <span class="links_name">Log Activities</span>
                </a>
                ...
                <?php $query = mysqli_query($conn, "SELECT SUM(size) as Total_Size FROM files");
                $data = mysqli_fetch_assoc($query);
                $space =  5242880000;
                $percent =  $data['Total_Size'] / $space * 100;
                ?>

                <div class="progressbar">
                    <div id="progress">
                        <span id="percent"><?php echo number_format(($data['Total_Size'] / 1000) / 1000, 2) ?> mb / <?php echo number_format($space / (1024 * 1024 * 1024)) ?>gb</span>
                        <div style="width: <?php echo number_format($percent, 2) ?>%" id="bar"></div>
                    </div>
                </div>
        ...
        <div id="page-content-wrapper">
            <!-- Top navigation-->
            <nav class="navbar navbar-expand-lg navbar-light border-bottom no-border bg-white">
                <div class="container-fluid cfheader">
